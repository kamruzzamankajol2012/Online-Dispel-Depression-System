...
<?php include_once("../config.php");?>
  ...
  $query="INSERT INTO story(problem,solution) Values('$problem', '$solution')";
     ...
     <div class="col-md-12">
      <div class="card" style="background-color:">
        <div class="card-header text-center">
          <h3 class="lead">Anxiety and fears</h3>
  </div>
        <div class="card-body text-dark bg-light">
          ...
          <div class="col-md-12">
            ...
            <form class="form-group " action="prb.php" method="post" style="padding-left: 0px">
          <div class="col-md-12">
