...
<?php include_once("../config.php");?>
  ...
  $query="INSERT INTO story1(problem,solution) Values('$problem', '$solution')";
     ...
     <div class="col-md-12">
      <div class="card" style="background-color:">
        <div class="card-header text-center">
          <h3 class="lead">Managing Anger</h3>
  </div>
        <div class="card-body text-dark bg-light">
          ...
          <div class="col-md-12">
            ...
            <form class="form-group " action="m.php" method="post" style="padding-left: 0px">
          <div class="col-md-12">
