      ...
      <div class="card" style="background-color:">
        ...
        <div class="card-body text-dark bg-light">
          ...
          <div class="col-md-12">
            ...
            <form class="form-group " action="cngpass.php" method="post" style="padding-left: 0px">
          <div class="col-md-12">
            <div class="form-group">
              <textarea cols="30" rows="2" name="user" class="form-control" placeholder="Name" ></textarea>
            </div>
          </div>
          <div class="col-md-12">
            <div class="form-group">
              <textarea cols="30" rows="2" name="password" class="form-control" placeholder="Password" ></textarea>
            </div>
          </div>
          <div class="col-md-12">
