...
<?php include_once("../config.php");?>
  ...
  $query="INSERT INTO others(problem,solution) Values('$problem', '$solution')";
      ...
      <div class="card" style="background-color:">
        ...
        <div class="card-body text-dark bg-light">
          ...
          <div class="col-md-12">
            ...
            <form class="form-group " action="o.php" method="post" style="padding-left: 0px">
          <div class="col-md-12">
