...
<?php include_once("../config.php");?>
  ...
  $query="INSERT INTO ar(tittle,name,article,surce) Values('$tittle', '$name', '$article', '$surce')";
      ...
      <div class="card" style="background-color:">
        ...
        <div class="card-body text-dark bg-light">
          ...
          <div class="col-md-12">
            ...
            <form class="form-group " action="article.php" method="post" style="padding-left: 0px">
          <div class="col-md-12">
          ...
          <div class="col-md-12">
            <div class="form-group">
              <textarea cols="30" rows="2" name="article" class="form-control" placeholder="Article" ></textarea>
            </div>
          </div>
          <div class="col-md-12">
            <div class="form-group">
              <input type="text"name="surce" class="form-control" placeholder="Source"/>
            </div>
          </div>
          <div class="col-md-12">
