...
<div class="container">
  <h2 class="display-4 pb-5">Anxiety and fears</h2>
 <div class="row ">
    ...
    <h3>Problem with Solution</h3>
               ...
               <div class="card-body">
                ...
                <!-- end pagination-->
                 <?php
                   $db = new Database();
                   $query = "SELECT * FROM story limit $start_from ,$per_page";
...
$total_pages = ceil($total_rows/$per_page);
 ...
 echo "<span class='text-center paginatio '><a href='fear.php?page=1' >".'First Page'."</a>" ;
for($i=1;$i<=$total_pages;$i++){
  echo "<a href='fear.php?page=".$i."'>".$i."</a>";
}
echo "<a href='fear.php?page=$total_pages' >".'Last Page'."</a></span>" ?>
<!-- end pagination-->
   </div>
