...
<div class="container">
  <h2 class="display-4 pb-5">Other</h2>
 <div class="row ">
    ...
    <h3>Problem with Solution</h3>
               ...
               <div class="card-body">
                ...
                <!-- end pagination-->
                 <?php
                   $db = new Database();
                   $query = "SELECT * FROM others limit $start_from ,$per_page";
...
$total_pages = ceil($total_rows/$per_page);
 ...
 echo "<span class='text-center paginatio '><a href='other.php?page=1' >".'First Page'."</a>" ;
for($i=1;$i<=$total_pages;$i++){
  echo "<a href='other.php?page=".$i."'>".$i."</a>";
}
echo "<a href='other.php?page=$total_pages' >".'Last Page'."</a></span>" ?>
<!-- end pagination-->
   </div>
...
<!--search
<section id="newsletter" class="py-5  text-dark text-center" style="background-color: #069388">
  <div class="container">
    <div class="row">
      <div class="col">
        <h2 class="display-4">
  ...
  <div class="input-group mb-2 mr-sm-2 mb-sm-0">
    ...
    <input type="email" class="form-control" id="inlineFormInputGroup" placeholder="Search Here">
  </div>
