...
<div class="container">
  <h2 class="display-4 pb-5">Stress</h2>
 <div class="row ">
    ...
    <h3>Article</h3>
               ...
               <div class="card-body">
                ...
                <!-- end pagination-->
                 <?php
                   $db = new Database();
                   $query = "SELECT * FROM ar limit $start_from ,$per_page";
                   $read = $db->select($query);
                    ?>
                    <?php if($read) {?>
                          <?php while($row = $read->fetch_assoc()){ ?>
                            <p class="lead text-left font-weight-bold"> <b>Tittle:</b></p>
               ...
               <p class="lead text-left font-weight-bold"> <b>Author Name:</b></p>               
               <p class="lead text-left">
                 <?php echo $row['name'] ;?>

               </p><br>
               <p class="lead text-left font-weight-bold"> <b>Article:</b></p>
               <p class="lead text-left">
                 <?php echo $row['article'] ;?>

               </p><br>
                <p class="lead text-left font-weight-bold"> <b>Source:</b></p>
               <p class="lead text-left">
                 <?php echo $row['surce'] ;?>
...
$total_pages = ceil($total_rows/$per_page);
 ...
 echo "<span class='text-center paginatio '><a href='teen.php?page=1' >".'First Page'."</a>" ;
for($i=1;$i<=$total_pages;$i++){
  echo "<a href='teen.php?page=".$i."'>".$i."</a>";
}
echo "<a href='teen.php?page=$total_pages' >".'Last Page'."</a></span>" ?>
<!-- end pagination-->
   </div>
