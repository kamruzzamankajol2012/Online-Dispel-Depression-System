...
<div class="container">
  <h2 class="display-4 pb-5">Family</h2>
 <div class="row ">
    ...
    <h3>Problem with Solution</h3>
               ...
               <div class="card-body">
                ...
                <!-- end pagination-->
                 <?php
                   $db = new Database();
                   $query = "SELECT * FROM famly limit $start_from ,$per_page";
...
<!-- start pagination-->
<?php 
$query = "SELECT * FROM famly";
$row =$db->select($query);
$total_rows = mysqli_num_rows($row);
$total_pages = ceil($total_rows/$per_page);

 echo "<span class='text-center paginatio '><a href='fam.php?page=1' >".'First Page'."</a>" ;
for($i=1;$i<=$total_pages;$i++){
  echo "<a href='fam.php?page=".$i."'>".$i."</a>";
}
echo "<a href='fam.php?page=$total_pages' >".'Last Page'."</a></span>" ?>
<!-- end pagination-->
   </div>
